...
function AboutUs (){
    return(
        ...
        <section id="AboutUs" className=" flex pt-20 md:flex-row justify-center flex-col bg-[#02001b] text-amber-50 min-h-140 md:min-h-130 ">
            <img className="z-1  md:self-baseline   max-h-60 md:w-5/11   w-9/11 self-center md:align-center -mb-10 md:-mr-10 " src="/src/imges/about-us-section-img.webp" alt="chief img" />
